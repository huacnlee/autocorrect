...
pub fn is_support_type(filename_or_ext: &str) -> bool {
  return FILE_TYPES.contains_key(filename_or_ext);
}
...
mod tests {
  ...
  fn is_is_support_type() {
    assert_eq!(is_support_type("html"), true);
    assert_eq!(is_support_type("htm"), true);
    assert_eq!(is_support_type("html.erb"), true);
    assert_eq!(is_support_type("rust"), true);
    assert_eq!(is_support_type("rs"), true);
    assert_eq!(is_support_type("foo"), false);
    assert_eq!(is_support_type("index.html"), false);
  }
